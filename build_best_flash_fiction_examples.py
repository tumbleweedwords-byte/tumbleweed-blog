...
<p>I have been writing and publishing flash fiction for twenty years. My work has appeared in Adelaide Magazine, Litro, Cleaver Magazine, Poetry Scotland, White Wall Review, and others. I was nominated for a Pushcart Prize. Every piece I have written owes something to the stories below.</p>
...
with open('C:/Users/tumbl/projects/tumbleewords/best-flash-fiction-examples.html', 'w', encoding='utf-8') as f:
    f.write(html)

print('best-flash-fiction-examples.html written successfully.')
